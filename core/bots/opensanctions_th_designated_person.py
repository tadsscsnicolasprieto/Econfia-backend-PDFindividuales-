# bots/opensanctions_th_designated_person.py
...
# Nombre EXACTO que debe existir en tu tabla Fuente
NOMBRE_SITIO = "opensanctions_th_designated_person"

# Búsqueda filtrada por el dataset de Tailandia
URL_SEARCH = "https://www.opensanctions.org/search/?scope=th_designated_person&q={q}"
GOTO_TIMEOUT_MS = 180_000

# Selectores robustos (coincidencia parcial de clase)
...
async def consultar_opensanctions_th_designated_person(consulta_id: int, nombre: str, apellido: str):
    navegador = None
    ...
    try:
        async with async_playwright() as p:
            ...
            # 3) Ir a la URL de búsqueda con scope de Tailandia
            ...
            if await nores.count() > 0 and await nores.first.is_visible():
                ...
                # 5) Iterar resultados y comprobar coincidencia exacta contra el título
