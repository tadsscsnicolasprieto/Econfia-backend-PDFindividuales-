# bots/cpiq_validacion_certificado_vigencia.py
import os
import re
import asyncio
...
NOMBRE_SITIO = "cpiq_validacion_certificado_vigencia"

# Selectores
SEL_INPUT = '#id_number_cv'  # <input type="text" name="id_number_cv" id="id_number_cv" ...>
SEL_RESULT_HINTS = [
    "text=Resultado de la validación",
    "text=vigencia", "text=no se encuentra",
...
async def consultar_cpiq_validacion_certificado_vigencia(
    consulta_id: int,
    numero: str  # cédula a usar como "código de verificación"
):
    """
    CPIQ – Validación del certificado de vigencia:
      - Abre https://www.cpiq.gov.co/validacion_certificado_vigencia.php
      - Ingresa la cédula en el campo id_number_cv
      - Presiona Enter
      - Espera el resultado y toma screenshot
    """
    browser = None
    ...
    try:
        ...
        async with async_playwright() as p:
            ...
            # Navegar
            await page.goto("https://www.cpiq.gov.co/validacion_certificado_vigencia.php",
            ...
            # Reescribir la cédula para el screenshot
            try:
                await inp.fill("")
