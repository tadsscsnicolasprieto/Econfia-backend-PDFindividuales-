# bots/opensanctions_nl_terrorism.py
...
NOMBRE_SITIO = "opensanctions_nl_terrorism"  # crea/asegura esta Fuente en DB
URL_SEARCH = "https://www.opensanctions.org/search/?scope=nl_terrorism_list&q={q}"
GOTO_TIMEOUT_MS = 180_000

# Selectores robustos a clases con hash
...
async def consultar_opensanctions_nl_terrorism(consulta_id: int, nombre: str, apellido: str):
    navegador = None
    ...
    try:
        async with async_playwright() as p:
            ...
            # 3) Ir a la URL de búsqueda (scope=nl_terrorism_list)
