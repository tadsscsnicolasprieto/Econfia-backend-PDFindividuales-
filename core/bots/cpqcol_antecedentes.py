...
NOMBRE_SITIO = "cpqcol_antecedentes"

# Selectores
SEL_INPUT_NUM = "#number"   # mismo id que en /verificar
SEL_BTN_SUBMIT = "button[type='submit'], button:has-text('CONSULTAR'), button:has-text('Consultar')"

# Señales de resultado (banner/resultado)
SEL_RESULT_HINTS = [
    "text=ANTECEDENTES",                          # encabezado típico
    "text=El valor enviado no coincide",          # banner de error
    "div[role='alert']",
    ".alert", ".toast", ".text-red-600", ".text-green-600",
]
...
async def consultar_cpqcol_antecedentes(
    consulta_id: int,
    numero: str,   # cédula o código
):
    """
    CPQCOL – Antecedentes:
      - Abre https://tramites.cpqcol.gov.co/antecedentes
    ...
    try:
        ...
        async with async_playwright() as p:
            ...
            # Navegar
            await page.goto("https://tramites.cpqcol.gov.co/antecedentes",
            ...
            # (Si prefieres clic, usa: await page.locator(SEL_BTN_SUBMIT).first.click())
