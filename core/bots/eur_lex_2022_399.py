...
NOMBRE_SITIO = "eur_lex_2022_399"  # crea/usa esta Fuente en tu tabla
...
async def consultar_eur_lex_2022_399(consulta_id: int, nombre: str, apellido: str):
    navegador = None
    ...
    try:
        async with async_playwright() as p:
            ...
            # 3) URL de búsqueda (qid cambia siempre)
