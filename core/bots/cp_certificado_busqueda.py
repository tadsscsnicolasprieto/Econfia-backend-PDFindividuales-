# core/bots/cp_certificado_busqueda.py
import os
import re
import asyncio
...
NOMBRE_SITIO = "cp_certificado_busqueda"
URL = "https://www.consejoprofesional.org.co/certificado"

# Selectores
SEL_INPUT_DOC = "#documento"
SEL_BTN_BUSCAR = "#buscar-documento"
...
async def consultar_cp_certificado_busqueda(
    consulta_id: int,
    numero: str,  # cédula
):
    """
    Consejo Profesional – Certificado (/certificado):
      - Escribe 'numero' en #documento
      - Click en 'Buscar'
      - Espera 3s
