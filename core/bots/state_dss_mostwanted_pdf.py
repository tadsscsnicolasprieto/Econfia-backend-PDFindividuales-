# bots/state_dss_mostwanted_pdf_async.py
import os, asyncio
...
URL = "https://2021-2025.state.gov/most-wanted/DSS"
NOMBRE_SITIO = "state_dss_mostwanted"
...
async def _is_cloudfront_block(page) -> bool:
    """Detecta el 403 de CloudFront (Request blocked / The request could not be satisfied)."""
    try:
...
async def consultar_state_dss_mostwanted_pdf(consulta_id: int, nombre: str, cedula: str):
    # Rutas de salida
    ...
    try:
        async with async_playwright() as p:
            ...
            # 1) Abrir página DSS Most Wanted
            await page.goto(URL, timeout=120000, wait_until="domcontentloaded")
            try: await page.wait_for_load_state("networkidle", timeout=15000)
            except Exception: pass
            await _aceptar_cookies(page)

            # 2) Abrir buscador global y consultar
            try:
        ...
        await sync_to_async(Resultado.objects.create)(
            consulta_id=consulta_id, fuente=fuente_obj,
            score=score, estado="Validada", mensaje=mensaje, archivo=out_png_rel
        )
